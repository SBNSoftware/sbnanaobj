...
namespace caf
{
  ...
  SRTrueParticle::SRTrueParticle():
    ...
    plane1nhit(0),
    plane2nhit(0),
    scdy_startT(std::numeric_limits<float>::signaling_NaN()),
    scdy_startE(std::numeric_limits<float>::signaling_NaN()),
    prim_endT(std::numeric_limits<float>::signaling_NaN()),
    prim_endE(std::numeric_limits<float>::signaling_NaN()),
    wallin(kWallNone),
    wallout(kWallNone),
    cont_tpc(false),
    crosses_tpc(false),
