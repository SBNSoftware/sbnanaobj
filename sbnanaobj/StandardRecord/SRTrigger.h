...
namespace caf
{
  ...
  public:
    ...
    u_int64_t prev_global_trigger_time; ///< Time of the last trigger in this stream in UTC [ns]
    int source_type; ///< gate source type
    ...
    int gate_delta; ///< Number of gates since previous trigger in this stream
