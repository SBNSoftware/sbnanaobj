...
namespace caf
{
  ...
  class SRShower
    ...
    public:
      ...
      float energy_plane0;          ///< shower calculated energy at each plane [GeV]
      float energy_plane1;          ///< shower calculated energy at each plane [GeV]
      float energy_plane2;          ///< shower calculated energy at each plane [GeV]
